...
void ed25519_genpub(uint8_t pub[ED25519_KEY_LEN],
...
void x25519(uint8_t out[X25519_KEY_LEN], const uint8_t scalar[X25519_KEY_LEN],
...
void eddsa_sign(uint8_t sig[64],
			   const uint8_t sec[32],
			   const uint8_t pub[32],
			   const uint8_t *data, size_t len);

int eddsa_verify(const uint8_t sig[64],
			     const uint8_t pub[32],
			     const uint8_t *data, size_t len);


/* diffie-hellman */
void DH(uint8_t out[32], const uint8_t sec[32], const uint8_t point[32]);


/* key conversion */
void eddsa_pk_eddsa_to_dh(uint8_t out[32],
				     const uint8_t in[32]);

void eddsa_sk_eddsa_to_dh(uint8_t out[32],
				     const uint8_t in[32]);
