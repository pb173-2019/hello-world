...
ClientSocket::ClientSocket(Callable<void, std::stringstream &&> *callback,
        ...
        : QObject(parent),
          ...
          _port(port), _address(QString().fromStdString(addr)), _socket(new QTcpSocket(this)) {
    QObject::connect(_socket.get(), SIGNAL(stateChanged(QAbstractSocket::SocketState)), this,
