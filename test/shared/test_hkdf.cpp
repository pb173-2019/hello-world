...
TEST_CASE("test vectors RFC5869") {
    ...
    SECTION("SECTION 1") {
        ...
        for (size_t i = 0; i < 13; i++)
            salt.push_back(i);
        len = 42;
        result = "3cb25f25faacd57a90434f64d0362f2a"
    ...
    SECTION("SECTION 2") {
        ...
        hmacFunction = std::make_unique<hmac_base<MBEDTLS_MD_SHA256, 32> >();
        result = "b11e398dc80327a1c8e7f78c596a4934"
    ...
    SECTION("SECTION 4") {
        ...
        for (size_t i = 0; i < 13; i++)
            salt.push_back(i);
        len = 42;
        result = "085a01ea1b10f36933068b56efa5ad81"
    ...
    SECTION("SECTION 5") {
        ...
        hmacFunction = std::make_unique<hmac_base<MBEDTLS_MD_SHA1, 20> >();
        result = "0bd770a74d1160f7c9f12cd5912a06eb"
