...
namespace helloworld {
    ...
    public:
        ...
        void connect(std::string ip, uint16_t port) {
            ...
            QObject::connect(socket.get(), SIGNAL(readyRead()), this, SLOT(receive()));
            QObject::connect(socket.get(), SIGNAL(disconnected()), this, SLOT(disconnect()));
    ...
    struct EchoCallback : public Callable<void, bool, const std::string&, std::stringstream&&> {
        ServerTCP *server;
